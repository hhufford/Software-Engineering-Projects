 ...
 * Used as part of the Abstract Person assignment
 * 
 * @author Mark Baldwin
 * @author Cyndi Rader
 * 
...
public class Party {
	...
	public Party() {
		...
		people.add(new Hobo("Plato", "Hobo"));
		people.add(new DogOwner("Ben", "Dog Park frequenter", "Spot", "Fluffy"));
		people.add(new Cowboy("Jason", "Cowboy"));
